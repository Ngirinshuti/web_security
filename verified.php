...
<body style="margin-top: 0cm;margin-left: 0cm;">
  <div class="container h-100">
    <div class="d-flex justify-content-center h-100" >
      <div class="user_card">
        <div class="d-flex justify-content-center form_container">
          <form method="post" action="Verifynow.php" style="margin-left: 5cm;background-color: whitesmoke;text-align: center;width: 20cm;height: 10cm;">
            <h1 style="margin-left:0cm;">Verify Email </h1>
            <section></section>
    ...
    <input class="input-field" type="email" placeholder="Type your email here........ " name="email" required="">
          ...
          <input type="submit" name="sub" value="Submit" class="btn" style="background-color: dodgerblue;height: 1cm;width: 4cm;" ><br><br>
